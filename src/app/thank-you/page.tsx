  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex items-center justify-center bg-black font-inter">
      ...
      <div className="relative z-20 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
        ...
        >
          {/* PRICING LINK */}
          <Link href="/birmingham/prices" className="group flex items-center justify-between p-5 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 backdrop-blur-md rounded-2xl transition-all duration-300">
          ...
          {/* ED OVERVIEW LINK */}
          <Link href="/birmingham/erectile-dysfunction" className="group flex items-center justify-between p-5 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 backdrop-blur-md rounded-2xl transition-all duration-300">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#4041d1]/40 flex items-center justify-center text-blue-200">
          ...
          {/* P-SHOT LINK */}
          <Link href="/birmingham/p-shot" className="group flex items-center justify-between p-5 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 backdrop-blur-md rounded-2xl transition-all duration-300">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#4041d1]/40 flex items-center justify-center text-blue-200">
          ...
          {/* SHOCKWAVE LINK */}
          <Link href="/birmingham/shockwave-therapy-erectile-dysfunction" className="group flex items-center justify-between p-5 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 backdrop-blur-md rounded-2xl transition-all duration-300">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-[#4041d1]/40 flex items-center justify-center text-blue-200">
