...
export default function InstaLeadForm({ campaignName }: InstaLeadFormProps) {
  ...
  const [errorMessage, setErrorMessage] = useState(""); // <-- New state for handling errors cleanly
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send(serviceId, templateId, {
        from_name: name,
        from_email: "instagram-lead@healing-prp.co.uk", 
        phone: phone,
        treatment: campaignName,
        clinic_location: "Instagram Ad Lead", 
