                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div className="bg-white rounded-xl p-6">
                      ...
                      <motion.button
                        ...
                        /* UPDATED: Added hex codes for brand consistency and matched padding to Birmingham standard */
                        className="inline-flex items-center text-sm gap-2 mt-6 px-10 py-3.5 bg-[#4041d1] hover:bg-[#2a2bb8] text-white rounded-xl font-inter font-bold transition-all duration-300 shadow-lg shadow-blue-500/20 group"
                        whileTap={{ scale: 0.95 }}
                      >
                        <FaEnvelope className="w-4 h-4 group-hover:rotate-12 transition-transform" />
                        Book Consultation
                  ...
                  <div className="">
                    <motion.button
                      ...
                      /* UPDATED: Changed text variable to hex #4041d1 for perfect matching */
                      className="inline-flex items-center gap-2 py-3 text-[#4041d1] rounded-lg font-inter text-sm transition-all duration-300 hover:opacity-50 cursor-pointer"
                      whileTap={{ scale: 0.95 }}
                    >
                      {expandedTreatment === treatment.name ? (
                        <>
      ...
      <section className="py-12 bg-white border-t border-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-center items-center gap-4">
          ...
          <Link
            ...
            /* UPDATED: Changed to hex #4041d1, hover #2a2bb8, and rounded-xl */
            className="px-10 py-3.5 w-full md:w-max text-sm flex items-center justify-center cursor-pointer bg-[#4041d1] hover:bg-[#2a2bb8] text-white rounded-xl font-inter font-bold transition-all duration-300 inline-flex items-center gap-2 shadow-lg active:scale-95"
          >
          ...
          <Link
            ...
            /* UPDATED: Changed to hex #4041d1, hover bg #f0f0ff, and rounded-xl */
            className="px-10 py-3.5 w-full md:w-max text-sm flex items-center justify-center cursor-pointer border-2 border-[#4041d1] text-[#4041d1] hover:bg-[#f0f0ff] bg-white rounded-xl font-inter font-bold transition-all duration-300 inline-flex items-center gap-2 active:scale-95"
          >
            View Clinic FAQs
          </Link>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              ...
              variants={itemVariants}
            >
              {/* UPDATED: Using specific brand blue tints from globals.css */}
              <div className="inline-block px-4 py-2 bg-[#f0f0ff] text-[#1a1b99] rounded-full text-xs font-inter font-medium">
                Frequently Asked Questions
              </div>
            </motion.div>
            <motion.h2
              className="text-2xl lg:text-4xl tracking-tight font-raleway text-[#0a1128] leading-tight text-center"
              variants={itemVariants}
            >
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* UPDATED: Circle icon background uses brand blue tint */}
                    <motion.div
                      className="flex-shrink-0 w-8 h-8 bg-[#f0f0ff] rounded-full flex items-center justify-center"
                    ...
                    >
                      ...
                      >
                        {/* UPDATED: Icon color uses primary brand blue #4041d1 */}
