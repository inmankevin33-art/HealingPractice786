...
export default function ErectileDysfunctionClient() {
  ...
  return (
    <>
     {/* --- HERO SECTION (Magazine Style: Image Up, Text Bottom-Center) --- */}
      <section className="relative min-h-[75vh] flex flex-col justify-end overflow-hidden font-inter pb-16 md:pb-24">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img
            ...
            // VISUAL UPDATE: 'object-[50%_15%]' shifts focus up, keeping the head visible under the nav
            className="w-full h-full object-cover object-[50%_15%]" 
          />
        </div>

        <div className="relative z-20 w-full px-4 sm:px-6 lg:px-8">
          {/* CONTAINER: Centered and positioned at the bottom */}
