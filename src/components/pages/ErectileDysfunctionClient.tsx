        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-lg">
              {/* FIXED: Replaced double quotes with &quot; */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {symptoms.map((symptom, index) => (
              ...
              >
                <div className={`w-14 h-14 rounded-2xl ${symptom.color} flex items-center justify-center mb-6 text-2xl transition-transform group-hover:scale-110`}>
                  <symptom.icon />
                </div>
      ...
      <section className="relative py-20 lg:py-28 bg-[#0A1128] overflow-hidden font-inter" style={{ backgroundImage: "radial-gradient(circle at 10% 10%, rgba(64, 65, 209, 0.15) 0%, transparent 40%)" }}>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div className="text-center mb-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={containerVariants}>
            ...
            <motion.p className="text-base text-slate-200 leading-relaxed max-w-3xl mx-auto font-medium font-inter" variants={itemVariants}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12">
               ...
               <div className="w-full md:w-1/2">
                   ...
                   <ul className="space-y-4 mb-8">
                       {["Direct access to GMC-Registered Doctors", "No GP referral required", "Same-day treatments available"].map((item, i) => (
