...
export default function BirminghamHomeClient() {
  ...
  return (
    <div className="bg-slate-50 selection:bg-blue-100 selection:text-blue-900 transform-gpu overflow-x-hidden">
      ...
      {/* 2. CORE SERVICES GRID - Fixed Type Error Logic */}
            ...
            {[
              ...
              >
                ...
                <p className="text-slate-600 text-sm leading-relaxed mb-6">
                  Expert treatment plans tailored to your goals by GMC-registered doctors.
                </p>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative bg-white rounded-[2.5rem] p-8 max-w-md w-full shadow-2xl z-10"
            >
              <div className="text-center">
                ...
                <p className="text-slate-600 mb-8 text-sm">Get instant answers about PRP treatments in Birmingham via WhatsApp.</p>
                <a 
